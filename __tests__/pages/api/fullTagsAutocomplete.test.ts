...
describe("GET /api/fullTagsAutocomplete", () => {
  ...
  it("Should be able to search nodes with isTag true with specific title", async () => {
    ...
    await fullTagsAutocompleteHandler(req, res);
