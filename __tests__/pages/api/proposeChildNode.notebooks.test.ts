...
describe("POST /api/proposeChildNode", () => {
  ...
  // adding notebook property to test if new user nodes get this notebook id or not
  ...
  describe("testing notebook prop for newely created user nodes", () => {
