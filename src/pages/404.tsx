        ...
        <Box sx={{ width: "326px" }}>
          <Typography
            sx={{
              ...
              fontWeight: 600,
              color: theme =>
                theme.palette.mode === "dark" ? theme.palette.common.gray25 : theme.palette.common.gray800,
              mb: "16px",
            }}
          >
            404
          ...
          >
            Something went wrong! We appologize for the inconvenience! Please try again! If the issue persists, please contact iman@honor.education
          </Typography>
          <Typography
            sx={{
              fontWeight: 400,
              color: theme =>
                theme.palette.mode === "dark" ? theme.palette.common.notebookG200 : theme.palette.common.gray600,
              mb: "24px",
            }}
          >
