    ...
    syllabus: [
      {
        ...
        topics: [
          { topic: "History and Approaches to Psychology", hours: 0, difficulty: "Medium" },
          { topic: "Research Methods in Psychology", hours: 0, difficulty: "Medium" },
          { topic: "Ethical Considerations in Psychological Research", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Biological Bases of Behavior",
        topics: [
          { topic: "Neurons and Neurotransmission", hours: 0, difficulty: "Medium" },
          { topic: "Brain Structures and Functions", hours: 0, difficulty: "Medium" },
          { topic: "Sensation and Perception", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Cognition",
        topics: [
          { topic: "Learning and Conditioning", hours: 0, difficulty: "Medium" },
          { topic: "Memory Processes", hours: 0, difficulty: "Medium" },
          { topic: "Language and Thought", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Developmental Psychology",
        topics: [
          { topic: "Prenatal Development and Infancy", hours: 0, difficulty: "Medium" },
          { topic: "Childhood and Adolescence", hours: 0, difficulty: "Medium" },
          { topic: "Adulthood and Aging", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Personality and Individual Differences",
        topics: [
          { topic: "Major Theories of Personality", hours: 0, difficulty: "Medium" },
          { topic: "Measuring Personality", hours: 0, difficulty: "Medium" },
          { topic: "Psychological Testing", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Social Psychology",
        topics: [
          { topic: "Attitudes and Persuasion", hours: 0, difficulty: "Medium" },
          { topic: "Group Dynamics and Behavior", hours: 0, difficulty: "Medium" },
          { topic: "Prejudice and Discrimination", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Psychological Disorders",
        topics: [
          { topic: "Introduction to Psychological Disorders", hours: 0, difficulty: "Medium" },
          { topic: "Anxiety and Mood Disorders", hours: 0, difficulty: "Medium" },
          { topic: "Schizophrenia and Other Psychotic Disorders", hours: 0, difficulty: "Medium" },
          { topic: "Personality Disorders", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Therapies and Interventions",
        topics: [
          { topic: "Psychodynamic Therapy", hours: 0, difficulty: "Medium" },
          { topic: "Cognitive-Behavioral Therapy", hours: 0, difficulty: "Medium" },
          { topic: "Humanistic and Existential Therapies", hours: 0, difficulty: "Medium" },
          { topic: "Biological Treatments", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Applications of Psychology",
        topics: [
          { topic: "Psychology in Health and Well-being", hours: 0, difficulty: "Medium" },
          { topic: "Psychology in Education", hours: 0, difficulty: "Medium" },
          { topic: "Psychology in the Workplace", hours: 0, difficulty: "Medium" },
        ],
      },
    ],
  },
    ...
    syllabus: [
      {
        ...
        topics: [
          { topic: "History of Microbiology", hours: 0, difficulty: "Medium" },
          { topic: "Introduction to Microbial World", hours: 0, difficulty: "Medium" },
          { topic: "Microscopy and Staining Techniques", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Microbial Structure and Function",
        topics: [
          { topic: "Prokaryotic Cell Structure", hours: 0, difficulty: "Medium" },
          { topic: "Eukaryotic Cell Structure", hours: 0, difficulty: "Medium" },
          { topic: "Microbial Metabolism", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Microbial Genetics",
        topics: [
          { topic: "DNA Structure and Replication", hours: 0, difficulty: "Medium" },
          { topic: "Gene Expression and Regulation", hours: 0, difficulty: "Medium" },
          { topic: "Genetic Mutations and Transfer", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Microbial Growth and Control",
        topics: [
          { topic: "Microbial Growth Phases", hours: 0, difficulty: "Medium" },
          { topic: "Factors Affecting Microbial Growth", hours: 0, difficulty: "Medium" },
          { topic: "Methods of Microbial Control", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Microbial Interactions",
        topics: [
          { topic: "Microbiome and Human Health", hours: 0, difficulty: "Medium" },
          { topic: "Pathogenic Microorganisms", hours: 0, difficulty: "Medium" },
          { topic: "Symbiotic Relationships", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Applied Microbiology",
        topics: [
          { topic: "Environmental Microbiology", hours: 0, difficulty: "Medium" },
          { topic: "Industrial Microbiology", hours: 0, difficulty: "Medium" },
          { topic: "Microbial Biotechnology", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Laboratory Techniques",
        topics: [
          { topic: "Aseptic Technique", hours: 0, difficulty: "Medium" },
          { topic: "Culturing Microorganisms", hours: 0, difficulty: "Medium" },
          { topic: "Antibiotic Sensitivity Testing", hours: 0, difficulty: "Medium" },
        ],
      },
    ],
  },
    ...
    syllabus: [
      {
        ...
        topics: [
          { topic: "Introduction to Microeconomics", hours: 0, difficulty: "Medium" },
          { topic: "Scarcity and Choice", hours: 0, difficulty: "Medium" },
          { topic: "Opportunity Cost", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Supply and Demand",
        topics: [
          { topic: "Market Demand", hours: 0, difficulty: "Medium" },
          { topic: "Market Supply", hours: 0, difficulty: "Medium" },
          { topic: "Equilibrium Price and Quantity", hours: 0, difficulty: "Medium" },
          { topic: "Elasticity of Demand", hours: 0, difficulty: "Medium" },
          { topic: "Elasticity of Supply", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Consumer Behavior",
        topics: [
          { topic: "Utility and Preferences", hours: 0, difficulty: "Medium" },
          { topic: "Budget Constraints", hours: 0, difficulty: "Medium" },
          { topic: "Consumer Choice", hours: 0, difficulty: "Medium" },
          { topic: "Demand Curve", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Production and Costs",
        topics: [
          { topic: "Production Functions", hours: 0, difficulty: "Medium" },
          { topic: "Short-Run Costs", hours: 0, difficulty: "Medium" },
          { topic: "Long-Run Costs", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Market Structures",
        topics: [
          { topic: "Perfect Competition", hours: 0, difficulty: "Medium" },
          { topic: "Monopoly", hours: 0, difficulty: "Medium" },
          { topic: "Monopolistic Competition", hours: 0, difficulty: "Medium" },
          { topic: "Oligopoly", hours: 0, difficulty: "Medium" },
        ],
      },
      {
        category: "Welfare Economics",
        topics: [
          { topic: "Economic Efficiency", hours: 0, difficulty: "Medium" },
          { topic: "Market Failure", hours: 0, difficulty: "Medium" },
          { topic: "Public Goods", hours: 0, difficulty: "Medium" },
          { topic: "Externalities", hours: 0, difficulty: "Medium" },
        ],
      },
    ],
  },
