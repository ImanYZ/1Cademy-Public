    ...
    <Box sx={{ m: 5 }}>
      <Box sx={{ textAlign: "center" }}>
        ...
        <Typography variant="h2">
          How do Linear vs. Non-linear vs. hybrid representations of text affect scientific reading comprehension?
        </Typography>
        <Typography variant="h2">HUM00201762</Typography>
      </Box>
      <Box sx={{ m: 4 }}>
      ...
      <Box sx={{ m: 4 }}>
        <Typography variant="h4">Faculty Advisor</Typography>
        <Typography>
      ...
      <Typography variant="h3">Research Team</Typography>
      <Box component="ul">
        <li>
      ...
      <Typography paragraph>This study includes three sessions:</Typography>
      <ul>
      ...
      <Typography paragraph>There is no compensation for participation in this research.</Typography>
      <Typography paragraph>
      ...
      <Typography paragraph>We will not collect any sensitive or identifiable information.</Typography>
      <Typography paragraph>
        Information collected in this project may be shared with other researchers, but we will not share any
        information that could identify you.
      </Typography>

      <Typography paragraph>If you have questions about this research study, please contact:</Typography>
      <Typography paragraph>Principal Investigator: Iman YeckehZaare</Typography>
      <Typography paragraph>Email: oneweb@umich.edu</Typography>
      <Typography paragraph>Phone: (+1) (734) 647-6333</Typography>
      <Typography paragraph>Faculty Advisor: Paul Resnick</Typography>
      <Typography paragraph>Email: presnick@umich.edu</Typography>
      <Typography paragraph>
