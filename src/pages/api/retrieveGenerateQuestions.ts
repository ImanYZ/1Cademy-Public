...
Generate only helpful questions of various types to assess a student's understanding of a specified concept within a course with specified characteristics. 
The questions should vary in type (e.g., 'Multiple Choice', 'True/False', 'Short Answer', 'Essay', 'Matching', 'Fill in the Blank', 'Sequence Ordering', and 'Case Study') to comprehensively evaluate different levels of understanding and cognitive skills. 
Your response should be only a JSON object with the following structure:
{
  "questions": [
    {
      "question_type": "Multiple Choice",
...
Please take your time and carefully design the questions to assess:
...
Please do not generate similar questions. Fewer questions of higher quality are preferred over many questions of lower quality.
