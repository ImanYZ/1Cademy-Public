...
import { generateBardQueryResult, top4GoogleSearchResults, top4TypesenseSearch } from "src/utils/assistant-helpers";
...
async function handler(req: NextApiRequest, res: NextApiResponse<any>) {
  try {
    ...
    const nodes = await generateBardQueryResult(nodeIds, userData?.uname);
