...
const generateMorePromptsForTopic = async (
  ...
  const systemPrompt = `You are an expert in curriculum design and optimization. Given the course title, description, target learners, their prerequisite knowledge, number of hour-long class sessions, objectives, skills, current syllabus, and a specified topic, your task is to generate an array of additional prompts designed to encourage discussion among students and the instructor about the specified topic. Your response should not include anything other than a JSON object with a single key "prompts" whose value should be an array of prompts. Please take your time to think carefully before responding.
