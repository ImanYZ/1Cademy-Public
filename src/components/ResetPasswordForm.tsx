  ...
  const handleResetForgotPassword = async () => {
    try {
      ...
      if (!auth.currentUser || !auth.currentUser.email)
        return formik.setStatus({ success: false, msg: "Something went wrong when restoring your password! We appologize for the inconvenience! Please try again! If the issue persists, please contact iman@honor.education" });
