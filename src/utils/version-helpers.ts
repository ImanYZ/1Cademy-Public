...
export const addToPendingPropsNums = async ({ batch, tagIds, value, voters, writeCounts }: any) => {
  let newBatch = batch;
...
export const createPractice = async ({ batch, tagIds, nodeId, currentTimestamp, writeCounts }: any) => {
  let newBatch = batch;
...
export const getTagRefData = async (nodeId: string) => {
...
export const changeTagTitleInCollection = async ({ batch, collectionName, nodeId, newTitle, writeCounts }: any) => {
  let newBatch = batch;
...
export const getUserVersion = async ({ versionId, nodeType, uname }: any) => {
...
export const isVersionApproved = async ({ corrects, wrongs, nodeData }: any) => {
  try {
