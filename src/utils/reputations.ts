...
const firstWeekMonthDays = (thisDate?: any) => {
  let today = new Date();
  if (thisDate) {
...
const updateReputationIncrement = async ({
  ...
  if (reputationsDoc.docs.length > 0) {
    ...
    rep_Points = reputationDoc.docs[0].data();
  ...
  const reputationDoc_Obj = {
    ...rep_Points,
    // for Concept nodes
    cnCorrects: parseFloat(rep_Points.cnCorrects.toFixed(3)),
    cnInst: parseFloat(rep_Points.cnInst.toFixed(3)),
    cnWrongs: parseFloat(rep_Points.cnWrongs.toFixed(3)),
    // for Code nodes
    cdCorrects: parseFloat(rep_Points.cdCorrects.toFixed(3)),
    cdInst: parseFloat(rep_Points.cdInst.toFixed(3)),
    cdWrongs: parseFloat(rep_Points.cdWrongs.toFixed(3)),
    // for Question nodes
    qCorrects: parseFloat(rep_Points.qCorrects.toFixed(3)),
    qInst: parseFloat(rep_Points.qInst.toFixed(3)),
    qWrongs: parseFloat(rep_Points.qWrongs.toFixed(3)),
    //  for Profile nodes
    pCorrects: parseFloat(rep_Points.pCorrects.toFixed(3)),
    pInst: parseFloat(rep_Points.pInst.toFixed(3)),
    pWrongs: parseFloat(rep_Points.pWrongs.toFixed(3)),
    //  for Sequel nodes
    sCorrects: parseFloat(rep_Points.sCorrects.toFixed(3)),
    sInst: parseFloat(rep_Points.sInst.toFixed(3)),
    sWrongs: parseFloat(rep_Points.sWrongs.toFixed(3)),
    //  for Advertisement nodes
    aCorrects: parseFloat(rep_Points.aCorrects.toFixed(3)),
    aInst: parseFloat(rep_Points.aInst.toFixed(3)),
    aWrongs: parseFloat(rep_Points.aWrongs.toFixed(3)),
    //  for Reference nodes
    rfCorrects: parseFloat(rep_Points.rfCorrects.toFixed(3)),
    rfInst: parseFloat(rep_Points.rfInst.toFixed(3)),
    rfWrongs: parseFloat(rep_Points.rfWrongs.toFixed(3)),
    //  for News nodes
    nCorrects: parseFloat(rep_Points.nCorrects.toFixed(3)),
    nInst: parseFloat(rep_Points.nInst.toFixed(3)),
    nWrongs: parseFloat(rep_Points.nWrongs.toFixed(3)),
    //  for Idea nodes
    iCorrects: parseFloat(rep_Points.iCorrects.toFixed(3)),
    iInst: parseFloat(rep_Points.iInst.toFixed(3)),
    iWrongs: parseFloat(rep_Points.iWrongs.toFixed(3)),
    //  for Relation nodes
    mCorrects: parseFloat(rep_Points.mCorrects.toFixed(3)),
    mInst: parseFloat(rep_Points.mInst.toFixed(3)),
    mWrongs: parseFloat(rep_Points.mWrongs.toFixed(3)),
    lterm: parseFloat(rep_Points.lterm.toFixed(3)),
