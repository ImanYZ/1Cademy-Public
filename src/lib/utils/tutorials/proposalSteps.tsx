...
const OVERVIEW_STEPS: TutorialStepConfig[] = [
  {
...
const FINDING_PREREQUISITES_STEPS: TutorialStepConfig[] = [
  {
...
console.log(OVERVIEW_STEPS, PROPOSING_EDITS_STEPS, FINDING_PREREQUISITES_STEPS);
